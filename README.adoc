...
En utilisant votre éditeur en ligne (GitPod conseillé) ou local, réalisez un diagramme des cas d'utilisation pour le problème suivant.


=== Résultat attendu

Un fichier `uc.plantuml` à la racine de votre projet.